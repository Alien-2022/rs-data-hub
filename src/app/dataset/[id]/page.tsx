      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="space-y-3">
              {dataset.paper_url && (
                <a
                  ...
                  className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 hover:underline transition"
                >
        ...
        <div className="flex gap-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 px-6 py-4 bg-green-600 text-white text-center rounded-lg hover:bg-green-700 transition font-semibold flex items-center justify-center gap-2"
          >
